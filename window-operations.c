...
int main(int argc, char *argv[]) {
    ...
    /* example of moving a window. */
    {
        ...
        { /* this variable will store the ID of the root window of the screen */
            ...
            /* and this one will store the number of child windows our window
             * has. */
            unsigned int num_child_windows;
            /* finally, make the query for the above values. */
            XQueryTree(display, win, &root_win, &parent_win, &child_windows,
                       &num_child_windows);
        ...
        XTranslateCoordinates(display, parent_win, win_attr.root, x, y, &scr_x,
                              &scr_y, &child_win);
